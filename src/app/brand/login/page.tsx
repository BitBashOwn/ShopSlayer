      ...
      <div className="md:w-[55%] flex flex-col justify-center p-8 lg:p-16 relative">
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-end pt-1">
                <Link href="/brand/forgot-password" className="text-sm font-medium text-[#e8445a] hover:opacity-80">Forgot password?</Link>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <Link href="/role-select" className="text-gray-400 hover:text-gray-600 transition-colors text-sm">
              ← Switch role
            </Link>
          </div>
        </div>
