...
export default function BrandSignup() {
  ...
  const isFormValid =
    ...
    tiktokUrl.trim() !== "" && password.trim() !== "" && confirmPassword.trim() !== "" &&
      ...
      <div className="md:w-[45%] bg-[#1a1a6e] flex flex-col justify-between p-8 lg:p-16 text-white min-h-[40vh] md:min-h-screen">
        <div>
          ...
          <div className="max-w-md mb-12">
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-8">Reach thousands of TikTok creators</h2>
        ...
        <div className="bg-white/10 rounded-2xl p-6">
          <Quote className="text-[#e8445a] mb-4" size={32} />
          <p className="text-lg font-medium mb-4 leading-relaxed">&quot;ShopSlayer gave us 80 video submissions in our first campaign. Game changer.&quot;</p>
          <p className="text-gray-300 font-medium">— GlowLab Co.</p>
        </div>
      </div>

      {/* Right – White */}
      <div className="md:w-[55%] flex flex-col justify-center p-8 lg:p-16 relative overflow-y-auto">
        ...
        <div className="md:hidden text-center mb-8 text-sm text-gray-500">
          Already have an account?{" "}
          <Link href="/brand/login" className="text-[#e8445a]">Log In</Link>
        </div>

        <div className="max-w-md w-full mx-auto py-8">
          <h2 className="text-3xl font-bold text-[#1a1a6e] mb-2">Create your brand account</h2>
          <p className="text-gray-500 mb-8">Start posting campaigns and connecting with TikTok affiliates.</p>

          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-1.5">
              <label className="block text-sm font-semibold text-[#1a1a6e]">Company Name</label>
              <input type="text" placeholder="e.g., GlowLab Co." value={companyName} onChange={(e) => setCompanyName(e.target.value)}
            ...
            <div className="space-y-1.5">
              ...
              <input type="text" placeholder="Your full name" value={contactName} onChange={(e) => setContactName(e.target.value)}
                className="w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1a1a6e] transition-all" />
            </div>
            <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="https://shop.tiktok.com/..." value={tiktokUrl} onChange={(e) => setTiktokUrl(e.target.value)}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input type={showConfirm ? "text" : "password"} placeholder="Re-enter your password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1a1a6e] transition-all pr-12" />
                <button type="button" className="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-gray-600" onClick={() => setShowConfirm(!showConfirm)}>
                  {showConfirm ? <EyeOff size={20} /> : <Eye size={20} />}
                </button>
              </div>
            </div>
            <div className="flex items-center pt-2">
              <input id="terms" type="checkbox" checked={agreed} onChange={(e) => setAgreed(e.target.checked)} className="h-5 w-5 border-gray-300 rounded" />
              <label htmlFor="terms" className="ml-3 text-sm text-gray-700">
                I agree to ShopSlayer&apos;s{" "}<a href="#" className="text-[#e8445a] underline">Terms & Conditions</a>.
              </label>
            </div>
