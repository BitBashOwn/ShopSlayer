    ...
    <div className="min-h-screen bg-[#1a1a6e] flex flex-col items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 sm:p-10">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-[#1a1a6e] mb-2">Reset your password</h2>
        ...
        <div className="mt-8 text-center border-t border-gray-100 pt-6">
          <Link href="/admin/login" className="inline-flex items-center text-gray-500 hover:text-gray-800 text-sm font-medium">
