...
import StatsCard from "../admin_dashboard/statscard";
import CampaignTable from "../admin_dashboard/campaigntable";
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="border-b border-[#dde3ee] bg-white px-6 py-4">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <h1 className="text-[18px] font-semibold text-[#1e1b68]">
              Campaign Management
            </h1>
